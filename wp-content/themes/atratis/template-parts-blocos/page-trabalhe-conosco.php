    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                ...
                <a class="link-contato mt-3" href="<?php echo $link_whatsapp; ?>"
                    target="_blank"><?php echo get_sub_field('rotulo_do_botao'); ?>
            ...
            <div class="col-lg-8">
                <?php echo do_shortcode('[contact-form-7 id="829" title="Trabalhe Conosco"]'); ?>
            </div>
        </div>
    </div>
